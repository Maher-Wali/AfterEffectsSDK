...
enum {
	...
	PATHMASTER_INVERT,
	PATHMASTER_OPACITY,
	PATHMASTER_OUTPUT_COLOR,  // Added new output color parameter
...
enum {
	...
	DOWNSAMPLE_DISK_ID,
	OPACITY_DISK_ID,
	OUTPUT_COLOR_DISK_ID      // Added new disk ID for output color
};
typedef enum {
	StrID_NONE,
	StrID_Name,
	...
	StrID_OutputColorName,    // Added new string ID for output color
